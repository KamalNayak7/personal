...
class CategoryContainers {
    ...
    private function getCategoryHtml($sqlData, $title, $tvShows, $movies) {
        ...
        foreach($entities as $entity) {//evrytime looped over $entities item will be put  in $entity
            $entitiesHtml .= $previewProvider->createEntityPreviewSquare($entity);//pass entity to createEntityPreviewSquare  in $previewProvider
        }
